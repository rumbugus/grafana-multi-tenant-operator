...
GRAFANA_MULTI_TENANT_OPERATOR_HOST = os.getenv("GRAFANA_MULTI_TENANT_OPERATOR_HOST")
GRAFANA_MULTI_TENANT_OPERATOR_PORT = os.getenv("GRAFANA_MULTI_TENANT_OPERATOR_PORT")
...
GRAFANA_MULTI_TENANT_OPERATOR_VERIFY = os.getenv(
    "GRAFANA_MULTI_TENANT_OPERATOR_VERIFY", True
) in (True, "true")
GRAFANA_MULTI_TENANT_OPERATOR_TIMEOUT = float(
    os.getenv("GRAFANA_MULTI_TENANT_OPERATOR_TIMEOUT", "5.0")
)
...
api = GrafanaFace(
    auth=(
        GRAFANA_MULTI_TENANT_OPERATOR_ADMIN_USERNAME,
        GRAFANA_MULTI_TENANT_OPERATOR_ADMIN_PASSWORD,
    ),
